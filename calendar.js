...
async function loadEvents() {
  ...
  if (!data?.length) { calendarStatus.textContent = "No upcoming events yet. Something lovely may be taking shape."; return; }
...
loadEvents().catch((error) => { calendarStatus.textContent = error.message || "Events could not be loaded."; calendarStatus.classList.add("error"); });
